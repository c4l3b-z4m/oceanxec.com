      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-primary-foreground/60">
              Su aliado en logística internacional y trámites aduaneros en Ecuador. Simplificamos sus importaciones.
            </p>
          </div>
          ...
          <div>
            ...
            <nav className="mt-4 flex flex-col gap-3" aria-label="Enlaces del pie de página">
          ...
          <div>
            ...
            <div className="mt-4 flex gap-3">
              <a
                href="#"
                aria-label="LinkedIn"
                className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary-foreground/10 text-primary-foreground/60 transition-colors hover:bg-accent hover:text-accent-foreground"
              >
        ...
        <div className="mt-12 border-t border-primary-foreground/10 pt-8 text-center">
          <p className="text-sm text-primary-foreground/40">
            {'© 2026 Ocean Xpress. Todos los derechos reservados.'}
          </p>
        </div>
      </div>
    </footer>
